...
model.compile(optimizer="adam", loss='categorical_crossentropy',
              metrics=['accuracy'])
model.summary()
faces, emotions = load_fer2013('C:/Users/ASUS/Desktop/emotion_detection/fer2013.csv')
faces = preprocess(faces)

xtrain, xtest, ytrain, ytest = train_test_split(faces, emotions, test_size=0.2, shuffle=True)
     
history = model.fit(xtrain, ytrain, batch_size=32, epochs=2, verbose=1, validation_data=(xtest,ytest))
